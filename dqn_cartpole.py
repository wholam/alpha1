...
class DQN:
    ...
    def choose_action(self, state):
        ...
        actions_value = self.model.predict(state.reshape(1, 1, 4))
    ...
    def learn(self):
        ...
        if self.step % 5 == 0 and len(self.replay_memory) >= 200:
            ...
            # 训练决策网络
            self.model.fit(Obs.reshape(self.batch_size, 1, 4), Q, verbose=0)
    ...
    def save(self):
        self.model_target.save('./logs/' + name + 'cartpole.h5')
